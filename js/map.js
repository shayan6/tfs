...
(function($, window) {
	...
	function buildmapInfo(location, title, src, link) { //map html
			...
			.html(
				'<section class="bussinesscard">'
				  +'<div class="flip">'
				    +'<div class="front"> '      
				      +'<div class="top">'       
				        +'<div class="logo"><img src="https://lh3.googleusercontent.com/-w4bKHBT3tJM/V-p23seAaWI/AAAAAAAAABE/nWn7fqaEB7oAPRBKe0puzyIpfwFqzkeLgCEwYBhgL/w139-h140-p/13874742_1764011703839522_687909810_n.jpg" alt="">'
				      +'</div>'
				      +'</div>'
				      +'<div class="nametroduction">'
				        +'<div class="name">Shayan Shaikh</div>'
                      ...
                      +'<div class="contact text-center">'           
                        ...
                        +'<div class="client-description">'
                           +' <p>“Tez has helped me to fill in the financial crunch I face during the last days of a month. I have never used such fastest platform so far in the country”</p>'
                        +'</div>'
		...
		$("#map-info .close-btn").mouseup(function(e) {
